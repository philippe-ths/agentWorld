...
Subsystems can be toggled at runtime from the browser dev console: `FEATURES.goals = false`. See [Feature Toggles](doc/architecture.md#feature-toggles) for the full list and cascade rules.
